...
class FactorAnalysisTaskHandler:
    ...
    def __init__(self, request):
        ...
        self._factor_list = self._request['factor_list']
        self._strategy_list = self._request['strategy_list']
        self._group_list = self._request['group_list']
        self._position_list = self._request['position_list']
        self._task_list = []
        self._task_id = -1
    ...
    def schedule_task(self):
        ...
        # 需要創建不同組合工作
            ...
            combination = self._combinate_parameter()
    ...
    def _combinate_parameter(self):
        data = self._factor_list, self._strategy_list, self._group_list, self._position_list
        task_list = []
